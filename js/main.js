...
// function record () {
//     console.log("This is record button");
// }
...
const API_URL = "ws://" + window.location.hostname + ":8888/client/ws/speech";
...
function stop() {
    ...
    // Đổi lại nút
    $("#rec_btn").html('<img src="images/microphone.svg"/>');
...
function record() {
    ...
    //                     // Phục vụ tổng giám đốc Dũng nên không cần
    ...
    $('#rec-btn').html('<img style="padding-left: 30px;" src="./images/stop.svg"/>');
    ...
    // var url = API_URL
    //         + "?content-type=audio/x-raw,+layout=(string)interleaved,+rate=(int)" + audioContext.sampleRate
    //         + ",+format=(string)S16LE,+channels=(int)1&model=youtube"
    //         + '&token=' + token;
